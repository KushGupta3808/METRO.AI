...
* **The Dominant Shield (60%):** Deep Navy dominates the backgrounds, navigation bars, and text headers to ground the app in financial security.
* **The Action Trigger (10%):** Emerald Green is used strictly for call-to-action buttons, positive market trends (+), and the highest-ranked remittance provider options. This tells the user's eyes instantly where the value resides.
...
* **Design Philosophy:** `Inter` is an open-source sans-serif geometric typeface designed specifically for user interfaces and data-heavy dashboards (used by companies like Stripe and Figma). It features a tall x-height which ensures that numbers, exchange rates, and small percentages remain perfectly legible on mobile screens.
